...
import {updateProfile, getProfile} from '../actions/actions'
import {connect} from 'react-redux';

const EditProfile = ({profile: {loading, profile}, updateProfile, getProfile,  history}) => {
    ...
    const {status, company, website, location, skills, bio, githubusername, twitter, youtube, linkedin, facebook, instagram} = formData;

    const [displaySocialInputs, toggleSocialInputs] = useState(false)

    // const toggleSocialNetwork = () => setFormData({...formData, showSocialNetwork: !showSocialNetwork})
    ...
    return (
        <Fragment>
            ...
            <p className="lead">
                <i className="fas fa-user"></i> Let's change some information to make your profile stand out!
            </p>
...
export default connect(mapStateToProps, {updateProfile, getProfile}) (withRouter(EditProfile));